...
-- Sequence generator
CREATE TABLE USER_ID_SEQ (NEXT_VAL BIGINT);
INSERT INTO USER_ID_SEQ VALUES ( 1 );

-- Master data
INSERT INTO `user-app`.`GENDER` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('MALE', 'Male', 'ACTIVE', 'ADMIN');
INSERT INTO `user-app`.`GENDER` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('FEMALE', 'Female', 'ACTIVE', 'ADMIN');
INSERT INTO `user-app`.`GENDER` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('OTHER', 'Other', 'ACTIVE', 'ADMIN');

INSERT INTO `user-app`.`CITY` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('IND', 'India', 'ACTIVE', 'ADMIN');

INSERT INTO `user-app`.`STATE` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('KA', 'Karnataka', 'ACTIVE', 'ADMIN');
INSERT INTO `user-app`.`STATE` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('AD', 'Andhra Pradesh', 'ACTIVE', 'ADMIN');
INSERT INTO `user-app`.`STATE` (`CODE`, `NAME`, `STATUS`, `CREATED_BY`) VALUES ('MP', 'Madhya Pradesh', 'ACTIVE', 'ADMIN');

INSERT INTO `user-app`.`ROLE` (`ROLE_NAME`, `STATUS`, `CREATED_BY`) VALUES ('ADMIN', 'ACTIVE', 'SYSTEM');
INSERT INTO `user-app`.`ROLE` (`ROLE_NAME`, `STATUS`, `CREATED_BY`) VALUES ('USER', 'ACTIVE', 'SYSTE');
